...
$FileToHash = (Join-Path $BaseFolder "slimevr_*_offline_installer.exe" -Resolve) | Select-Object -First 1
$ManifestFile = (Join-Path $BaseFolder "slimevr_*_offline_installer.txt" -Resolve) | Select-Object -First 1
